...
public class project_main {
  ...
  */
  ...
  try {
    ...
    c = DriverManager.getConnection("jdbc:postgresql://127.0.0.1:5433/u7brunarski?currentSchema=lab11",
                                    "u7brunarski", "7brunarski");
...
if (c != null) {
    ...
    try { 
      ...
      //  Wykorzystane elementy: setString, executeQuery
       PreparedStatement pst = c.prepareStatement("SELECT id, fname, lname FROM osoba WHERE fname=?", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
